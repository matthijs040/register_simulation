...
rp2040_gpio::rp2040_gpio()
    : GPIO0_STATUS(0U), GPIO0_CTRL(0X1FU), GPIO1_STATUS(0U), GPIO1_CTRL(0X1FU),
      ...
      GPIO10_STATUS(0U), GPIO10_CTRL(0X1FU), GPIO11_STATUS(0U), GPIO11_CTRL(0X1FU),
      GPIO12_STATUS(0U), GPIO12_CTRL(0X1FU), GPIO13_STATUS(0U), GPIO13_CTRL(0X1FU),
      GPIO14_STATUS(0U), GPIO14_CTRL(0X1FU), GPIO15_STATUS(0U), GPIO15_CTRL(0X1FU),
      GPIO16_STATUS(0U), GPIO16_CTRL(0X1FU), GPIO17_STATUS(0U), GPIO17_CTRL(0X1FU),
      GPIO18_STATUS(0U), GPIO18_CTRL(0X1FU), GPIO19_STATUS(0U), GPIO19_CTRL(0X1FU),
      GPIO20_STATUS(0U), GPIO20_CTRL(0X1FU), GPIO21_STATUS(0U), GPIO21_CTRL(0X1FU),
      GPIO22_STATUS(0U), GPIO22_CTRL(0X1FU), GPIO23_STATUS(0U), GPIO23_CTRL(0X1FU),
      GPIO24_STATUS(0U), GPIO24_CTRL(0X1FU), GPIO25_STATUS(0U), GPIO25_CTRL(0X1FU),
      GPIO26_STATUS(0U), GPIO26_CTRL(0X1FU), GPIO27_STATUS(0U), GPIO27_CTRL(0X1FU),
      GPIO28_STATUS(0U), GPIO28_CTRL(0X1FU), GPIO29_STATUS(0U), GPIO29_CTRL(0X1FU) {
...
void gpio::set_pin_mode(pin_number number, gpio::mode mode) {
  ...
  if (mode == gpio::mode::disabled || mode == gpio::mode::input_only) {
    register_mask mask = 0x1 << 12;
    ctrl_reg &= ~mask;
    mask << 1;
    ctrl_reg |= mask;
  } else {
    const register_mask mask = 0x3 << 12;
    ctrl_reg |= mask;
  }
}
...
gpio::mode gpio::get_pin_mode(pin_number number) {
  ...
  return status_reg & static_cast<register_mask>(0x3 << 12) ? gpio::mode::input_and_output
...
gpio::state gpio::get_pin_state(pin_number number) {
  ...
  return reg & static_cast<register_mask>(0x1 << 17) ? gpio::state::high : gpio::state::low;
}