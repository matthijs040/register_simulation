...
template <typename Peripheral> struct simulated_peripheral {
...
private:
  static_assert(std::is_layout_compatible_v<device_register,
  ...
  static std::array<simulated_device_register, register_count>
      simulated_register_storage;
  static std::array<const simulated_device_register::effect_handlers,
                    register_count>
