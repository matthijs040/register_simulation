...
SIO::get_pin_OE(GPIO::pin_number number) const noexcept {
  ...
  switch (number) {
  case 0:
    return result = GPIO_OE.GPIO_0;
  case 1:
    return result = GPIO_OE.GPIO_1;
  case 2:
    return result = GPIO_OE.GPIO_2;
  case 3:
    return result = GPIO_OE.GPIO_3;
  case 4:
    return result = GPIO_OE.GPIO_4;
  case 5:
    return result = GPIO_OE.GPIO_5;
  case 6:
    return result = GPIO_OE.GPIO_6;
  case 7:
    return result = GPIO_OE.GPIO_7;
  case 8:
    return result = GPIO_OE.GPIO_8;
  case 9:
    return result = GPIO_OE.GPIO_9;
  case 10:
    return result = GPIO_OE.GPIO_10;
  case 11:
    return result = GPIO_OE.GPIO_11;
  case 12:
    return result = GPIO_OE.GPIO_12;
  case 13:
    return result = GPIO_OE.GPIO_13;
  case 14:
    return result = GPIO_OE.GPIO_14;
  case 15:
    return result = GPIO_OE.GPIO_15;
  case 16:
    return result = GPIO_OE.GPIO_16;
  case 17:
    return result = GPIO_OE.GPIO_17;
  case 18:
    return result = GPIO_OE.GPIO_18;
  case 19:
    return result = GPIO_OE.GPIO_19;
  case 20:
    return result = GPIO_OE.GPIO_20;
  case 21:
    return result = GPIO_OE.GPIO_21;
  case 22:
    return result = GPIO_OE.GPIO_22;
  case 23:
    return result = GPIO_OE.GPIO_23;
  case 24:
    return result = GPIO_OE.GPIO_24;
  case 25:
    return result = GPIO_OE.GPIO_25;
  case 26:
    return result = GPIO_OE.GPIO_26;
  case 27:
    return result = GPIO_OE.GPIO_27;
  case 28:
    return result = GPIO_OE.GPIO_28;
  case 29:
    return result = GPIO_OE.GPIO_29;
  default:
