...
private:
  ...
  device_register GPIO0_CTRL;         // GPIO control
  device_register GPIO1_STATUS;       // GPIO status
  device_register GPIO1_CTRL;         // GPIO control
  device_register GPIO2_STATUS;       // GPIO status
  device_register GPIO2_CTRL;         // GPIO control
  device_register GPIO3_STATUS;       // GPIO status
  device_register GPIO3_CTRL;         // GPIO control
  device_register GPIO4_STATUS;       // GPIO status
  device_register GPIO4_CTRL;         // GPIO control
  device_register GPIO5_STATUS;       // GPIO status
  device_register GPIO5_CTRL;         // GPIO control
  device_register GPIO6_STATUS;       // GPIO status
  device_register GPIO6_CTRL;         // GPIO control
  device_register GPIO7_STATUS;       // GPIO status
  device_register GPIO7_CTRL;         // GPIO control
  device_register GPIO8_STATUS;       // GPIO status
  device_register GPIO8_CTRL;         // GPIO control
  device_register GPIO9_STATUS;       // GPIO status
  device_register GPIO9_CTRL;         // GPIO control
  device_register GPIO10_STATUS;      // GPIO status
  device_register GPIO10_CTRL;        // GPIO control
  device_register GPIO11_STATUS;      // GPIO status
  device_register GPIO11_CTRL;        // GPIO control
  device_register GPIO12_STATUS;      // GPIO status
  device_register GPIO12_CTRL;        // GPIO control
  device_register GPIO13_STATUS;      // GPIO status
  device_register GPIO13_CTRL;        // GPIO control
  device_register GPIO14_STATUS;      // GPIO status
  device_register GPIO14_CTRL;        // GPIO control
  device_register GPIO15_STATUS;      // GPIO status
  device_register GPIO15_CTRL;        // GPIO control
  device_register GPIO16_STATUS;      // GPIO status
  device_register GPIO16_CTRL;        // GPIO control
  device_register GPIO17_STATUS;      // GPIO status
  device_register GPIO17_CTRL;        // GPIO control
  device_register GPIO18_STATUS;      // GPIO status
  device_register GPIO18_CTRL;        // GPIO control
  device_register GPIO19_STATUS;      // GPIO status
  device_register GPIO19_CTRL;        // GPIO control
  device_register GPIO20_STATUS;      // GPIO status
  device_register GPIO20_CTRL;        // GPIO control
  device_register GPIO21_STATUS;      // GPIO status
  device_register GPIO21_CTRL;        // GPIO control
  device_register GPIO22_STATUS;      // GPIO status
  device_register GPIO22_CTRL;        // GPIO control
  device_register GPIO23_STATUS;      // GPIO status
  device_register GPIO23_CTRL;        // GPIO control
  device_register GPIO24_STATUS;      // GPIO status
  device_register GPIO24_CTRL;        // GPIO control
  device_register GPIO25_STATUS;      // GPIO status
  device_register GPIO25_CTRL;        // GPIO control
  device_register GPIO26_STATUS;      // GPIO status
  device_register GPIO26_CTRL;        // GPIO control
  device_register GPIO27_STATUS;      // GPIO status
  device_register GPIO27_CTRL;        // GPIO control
  device_register GPIO28_STATUS;      // GPIO status
  device_register GPIO28_CTRL;        // GPIO control
  device_register GPIO29_STATUS;      // GPIO status
  device_register GPIO29_CTRL;        // GPIO control
  ...
  device_register PROC0_INTS0;        // Interrupt status for proc0
  device_register PROC0_INTS1;        // Interrupt status for proc0
  device_register PROC0_INTS2;        // Interrupt status for proc0
  device_register PROC0_INTS3;        // Interrupt status for proc0
  ...
  device_register PROC1_INTS0;        // Interrupt status for proc1
  device_register PROC1_INTS1;        // Interrupt status for proc1
  device_register PROC1_INTS2;        // Interrupt status for proc1
  device_register PROC1_INTS3;        // Interrupt status for proc1
  ...
  device_register DORMANT_WAKE_INTS0; // Interrupt Status for dormant_wake
  device_register DORMANT_WAKE_INTS1; // Interrupt Status for dormant_wake
